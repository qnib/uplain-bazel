...
ARG FROM_IMG_NAME="uplain-cudnn"
...
RUN apt-get update \
 ...
 && rm -rf /var/lib/apt/lists/*
RUN wget -qO /opt/bazel-installer-linux-x86_64.sh https://github.com/bazelbuild/bazel/releases/download/0.19.2/bazel-0.19.2-installer-linux-x86_64.sh
